...
execute if score mywar.hb mywar.dummy matches 1 positioned ~1 ~ ~ run function mywar:item/commands/home_base/home_base_x
execute store success score mywar.hb mywar.dummy run scoreboard players remove @s[scores={mywar.dummy=2..3}] mywar.dummy 2
execute if score mywar.hb mywar.dummy matches 1 positioned ~2 ~ ~ run function mywar:item/commands/home_base/home_base_x
execute store success score mywar.hb mywar.dummy run scoreboard players remove @s[scores={mywar.dummy=4..7}] mywar.dummy 4
execute if score mywar.hb mywar.dummy matches 1 positioned ~4 ~ ~ run function mywar:item/commands/home_base/home_base_x
execute store success score mywar.hb mywar.dummy run scoreboard players remove @s[scores={mywar.dummy=8..15}] mywar.dummy 8
execute if score mywar.hb mywar.dummy matches 1 positioned ~8 ~ ~ run function mywar:item/commands/home_base/home_base_x
execute store success score mywar.hb mywar.dummy run scoreboard players remove @s[scores={mywar.dummy=16..31}] mywar.dummy 16
execute if score mywar.hb mywar.dummy matches 1 positioned ~16 ~ ~ run function mywar:item/commands/home_base/home_base_x
execute store success score mywar.hb mywar.dummy run scoreboard players remove @s[scores={mywar.dummy=32..63}] mywar.dummy 32
execute if score mywar.hb mywar.dummy matches 1 positioned ~32 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~64 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~128 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~256 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~512 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~1024 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~2048 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~4096 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~8192 ~ ~ run function mywar:item/commands/home_base/iterate_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~16384 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~32768 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~65536 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~131072 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~262144 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~524288 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~1048576 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~2097152 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~4194304 ~ ~ run function mywar:item/commands/home_base/home_base_x
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~-8192 ~ ~ run function mywar:item/commands/home_base/home_base_x
