...
#Getting teams
execute as @e[tag=mywar.aggro_green_cloud] at @s run data modify entity @s Owner set from entity @e[tag=mywar.soldier,type=!skeleton_horse,team=mywar.green,sort=random,limit=1] UUID 
