...
data merge storage mywar:storage {root:{perm:{soldier:{foot_soldier:{zombie:{friendly:{CustomName:'{"text":"Foot Soldier","bold":false,"italic":false}',CustomNameVisible:1b,IsBaby:0b,Team:"mywar.friendly",IsImmuneToZombification:1b,PersistenceRequired:1b,Tags:["mywar.soldier","mywar.foot_soldier","mywar.modified"],ArmorItems:[{},{},{},{id:"minecraft:iron_helmet",Count:1b,tag:{Unbreakable:1b}}],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.movement_speed,Base:0.27},{Name:generic.attack_damage,Base:2},{Name:generic.attack_knockback,Base:1}]}}}}}}}

#Foot soldier zombie enemy 
data merge storage mywar:storage {root:{perm:{soldier:{foot_soldier:{zombie:{enemy:{CustomName:'{"text":"Foot Soldier","bold":false,"italic":false}',CustomNameVisible:1b,IsBaby:0b,DeathLootTable:"mywar:item/deplete",IsImmuneToZombification:1b,Team:"mywar.enemy",PersistenceRequired:1b,Tags:["mywar.soldier","mywar.foot_soldier","mywar.modified"],ArmorItems:[{},{},{},{id:"minecraft:iron_helmet",Count:1b,tag:{Unbreakable:1b}}],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.movement_speed,Base:0.27},{Name:generic.attack_damage,Base:2},{Name:generic.attack_knockback,Base:1}]}}}}}}}
