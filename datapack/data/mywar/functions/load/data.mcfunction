...
#Knight friendly
data merge storage mywar:storage {root:{perm:{soldier:{knight:{friendly:{CustomName:'{"text":"Knight","bold":false,"italic":false}',ArmorItems:[{id:"chainmail_boots", Count:1b,tag:{Unbreakable:1b}},{id:"chainmail_leggings",Count:1b,tag:{Unbreakable:1b}},{id:"chainmail_chestplate", Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:iron_helmet",Count:1b,tag:{Unbreakable:1b}}],CustomNameVisible:1b,IsBaby:0b,Team:"mywar.friendly",PersistenceRequired:1b,Tags:["mywar.soldier","mywar.knight","mywar.modified"],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.movement_speed,Base:0.27},{Name:generic.attack_damage,Base:2},{Name:generic.attack_knockback,Base:1}]}}}}}}

#Knight enemy 
data merge storage mywar:storage {root:{perm:{soldier:{knight:{enemy:{CustomName:'{"text":"Knight","bold":false,"italic":false}',CustomNameVisible:1b,IsBaby:0b,DeathLootTable:"mywar:item/deplete",Team:"mywar.enemy",PersistenceRequired:1b,Tags:["mywar.soldier","mywar.knight","mywar.modified"],ArmorItems:[{id:"chainmail_boots", Count:1b,tag:{Unbreakable:1b}},{id:"chainmail_leggings",Count:1b,tag:{Unbreakable:1b}},{id:"chainmail_chestplate", Count:1b,tag:{Unbreakable:1b}},{id:"minecraft:iron_helmet",Count:1b,tag:{Unbreakable:1b}}],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.movement_speed,Base:0.27},{Name:generic.attack_damage,Base:2},{Name:generic.attack_knockback,Base:1}]}}}}}}
