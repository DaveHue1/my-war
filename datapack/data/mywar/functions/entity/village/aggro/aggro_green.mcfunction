...
#Getting teams
execute as @e[tag=mywar.aggro_green_cloud] at @s if entity @e[tag=mywar.soldier,limit=1,team=!mywar.green] run data modify entity @s Owner set from entity @e[type=!player,type=!horse,type=!villager,team=!mywar.green,tag=mywar.soldier,sort=random,limit=1] UUID 
execute as @e[tag=mywar.aggro_green_cloud] at @s if entity @a[limit=1,team=!mywar.green] unless entity @e[tag=mywar.soldier,limit=1,team=!mywar.green] run data modify entity @s Owner set from entity @e[type=player,team=!mywar.green,sort=random,limit=1] UUID 
