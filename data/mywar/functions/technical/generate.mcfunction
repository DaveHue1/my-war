...
data modify entity @e[type=villager,tag=mywar.advisor,tag=mywar.entity,sort=nearest,limit=1] {CustomNameVisible:1b,Tags:["mywar.entity","mywar.advisor"],CustomName:'{"text":"Advisor","color":"aqua","bold":true,"italic":false}',VillagerData:{profession:"minecraft:nitwit"},Offers:{Recipes:[{buy:{id:"minecraft:ink_sac",Count:2b,tag:{display:{Name:'{"text":"Money","color":"yellow","bold":true,"italic":false}'},CustomModelData:1,mywar.currency, mywar.item}},sell:{id:"minecraft:vindicator_spawn_egg",Count:1b,tag:{EntityTag:{CustomNameVisible:1b,PersistenceRequired:1b,Johnny:0b,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,CustomName:'{"text":"Foot Soldier"}',HandItems:[{id:'minecraft:stone_sword',Count:1b},{}],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.knockback_resistance,Base:0.1},{Name:generic.movement_speed,Base:0.25},{Name:generic.attack_damage,Base:1.5},{Name:generic.attack_knockback,Base:1.2}]}}}}]}}
