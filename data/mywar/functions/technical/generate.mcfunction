...
data merge entity @e[type=villager,limit=1,sort=nearest,tag=mywar.advisor,tag=mywar.entity,tag=!mywar.advisor_merged] {CustomNameVisible:1b,Tags:["mywar.entity","mywar.advisor","mywar.advisor_merged"],CustomName:'{"text":"Advisor","color":"aqua","bold":true,"italic":false}',VillagerData:{profession:"minecraft:nitwit"},Offers:{Recipes:[{maxUses:2147483647,buy:{id:'minecraft:ink_sac',Count:2b,tag:{display:{Name:'{"text":"Money","color":"yellow","bold":true,"italic":false}'},CustomModelData:1,mywar.currency:1b,mywar.item:1b}},sell:{id:"minecraft:vindicator_spawn_egg",Count:1b,tag:{EntityTag:{CustomNameVisible:1b,Team:"mywar.friendly, mywar.soldier",PersistenceRequired:1b,Johnny:0b,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,CustomName:'{"text":"Foot Soldier","bold":false,"italic":false}',HandItems:[{id:'minecraft:stone_sword',Count:1b},{}],Attributes:[{Name:generic.follow_range,Base:500},{Name:generic.knockback_resistance,Base:0.1},{Name:generic.movement_speed,Base:0.25},{Name:generic.attack_damage,Base:1.5},{Name:generic.attack_knockback,Base:1.2}]}}}}]}}
