...
execute if entity @s[scores={mywar.dummy=0}] run function mywar:commands/home_base/home_base_z_init
...
execute if score mywar.hb mywar.dummy matches 1 positioned ~ ~8192 ~ run function mywar:commands/home_base/home_base_y
